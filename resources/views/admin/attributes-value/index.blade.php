                ...
                <table class="table m-0">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{route('attributes-value.destroy', $attribute->id)}}" class="btn btn-danger" onclick="return confirm('آیا از حذف ویژگی  مطمعئن هستید؟')">حذف</a>
                        </td>
